    ...
    <div id="navbar-container" class="boxed">
      ...
      <div class="navbar-header">
        <a href="index.html" class="navbar-brand">
          <img src="https://www.monroesmartstart.org/wp-content/uploads/2017/09/books-icon.png" alt="Learneed Logo" class="brand-icon">
          <div class="brand-title">
            <span class="brand-text">Learneed</span>
          </div>
        </a>
      </div>
      <!--================================-->
              ...
              <div class="row">
                <div class="col-sm-4 col-md-3">
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li><a>Invoice</a></li>
                    <li><a class="disabled">Disabled</a></li>                                        </ul>
                ...
                <div class="col-sm-4 col-md-3">
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li><a><span class="pull-right label label-danger">Hot</span>Indox</a></li>
                ...
                <div class="col-sm-12 col-md-3">
                  ...
                  <div class="row img-gallery">
                    <div class="col-xs-4">
                      <img class="img-responsive" :src="`${publicPath}admin-template/get-started/img/thumbs/img-1.jpg`" alt="thumbs">
                    </div>
                    <div class="col-xs-4">
                      <img class="img-responsive" :src="`${publicPath}admin-template/get-started/img/thumbs/img-3.jpg`" alt="thumbs">
                    </div>
                    <div class="col-xs-4">
                      <img class="img-responsive" :src="`${publicPath}admin-template/get-started/img/thumbs/img-2.jpg`" alt="thumbs">
                    </div>
                    <div class="col-xs-4">
                      <img class="img-responsive" :src="`${publicPath}admin-template/get-started/img/thumbs/img-4.jpg`" alt="thumbs">
                    </div>
                    <div class="col-xs-4">
                      <img class="img-responsive" :src="`${publicPath}admin-template/get-started/img/thumbs/img-6.jpg`" alt="thumbs">
                    </div>
                    <div class="col-xs-4">
                      <img class="img-responsive" :src="`${publicPath}admin-template/get-started/img/thumbs/img-5.jpg`" alt="thumbs">
                    </div>
                  </div>
                  <a class="btn btn-block btn-primary">Browse Gallery</a>
                </div>
              </div>
            </div>
          </li>
          ...
          <li id="dropdown-user" class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle text-right">
              <span class="ic-user pull-right">
                ...
                <!--<img class="img-circle img-user media-object" :src="`${publicPath}admin-template/get-started/img/profile-photos/1.png`" alt="Profile Picture">-->
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <i class="pli-male"></i>
              </span>
              <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            ...
            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
              <ul class="head-list">
                <li>
                  <a><i class="pli-male icon-lg icon-fw"></i> Profile</a>
                </li>
                <li>
                  <a><span class="badge badge-danger pull-right">9</span><i class="pli-mail icon-lg icon-fw"></i> Messages</a>
                </li>
                <li>
                  <a><span class="label label-success pull-right">New</span><i class="pli-gear icon-lg icon-fw"></i> Settings</a>
                </li>
                <li>
                  <a><i class="pli-computer-secure icon-lg icon-fw"></i> Lock screen</a>
                </li>
                <li>
                  <a href="/admin/logout"><i class="pli-unlock icon-lg icon-fw"></i> Logout</a>
                </li>
              </ul>
            </div>
          </li>
